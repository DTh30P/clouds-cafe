...
export default function Home() {
  ...
  <div className="pt-20 text-center bg-gradient-to-br from-blue-100 via-pink-100 to-blue-50 min-h-screen">
      {/* Hero */}
  <section id="home" className="bg-gradient-to-br from-blue-100 via-pink-100 to-blue-50 py-20 rounded-3xl shadow-lg max-w-4xl mx-auto mb-12 border-2" style={{ borderColor: '#89CFF0' }}>
...
Sweet, creative, and unforgettable - that’s the NUBE experience.</p>
  ...
  <div className="bg-gradient-to-br from-blue-100 via-pink-100 to-blue-50 rounded-3xl shadow-2xl border-2" style={{ borderColor: '#89CFF0' }}>
          ...
          <div className="flex flex-col md:flex-row gap-6 w-full justify-center items-center">
            <a href="tel:+15550000000" className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-white/90 border-2 shadow hover:bg-blue-50 transition font-bold text-lg w-full md:w-auto justify-center" style={{ borderColor: '#89CFF0', color: '#89CFF0' }}>
            ...
            <a href="https://www.tiktok.com/@nubeworldwide" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-white/90 border-2 shadow hover:bg-blue-50 transition font-bold text-lg w-full md:w-auto justify-center" style={{ borderColor: '#89CFF0', color: '#89CFF0' }}>
          ...
          <div className="mt-8 text-center w-full">
            <div className="inline-block bg-white/70 border-2 rounded-2xl px-6 py-4 shadow" style={{ borderColor: '#89CFF0', color: '#89CFF0' }}>
