      ...
      <section id="about" className="pt-24 pb-16 px-4 max-w-4xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl flex flex-col md:flex-row items-center gap-8 p-10 md:p-16 max-w-4xl mx-auto">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="font-semibold" style={{ color: '#ffb7ce' }}>Born from a group of friends with a shared vision, NUBE brings sweet innovation to Zürich - made to surprise, delight, and inspire.</p>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="pt-24 pb-16 px-4 max-w-4xl mx-auto">
        <div className="bg-white rounded-3xl shadow-2xl max-w-4xl mx-auto p-6 md:p-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 w-full justify-center items-center">
            ...
            <a href="https://www.instagr.am/nubeworldwide" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-6 py-4 rounded-2xl bg-white/90 border-2 border-pink-200 shadow hover:bg-pink-50 transition font-bold text-lg w-full md:w-auto justify-center" style={{ color: '#ffb7ce' }}>
